...
function DownFooter() {
  return(
      <div className="h-[200px] lg:h-[100px] py-5 grid grid-rows-[30%_20%_30%_20%] lg:grid-cols-[45%_40%_15%] bg-[#1A1A1A] -ml-[10%] w-[120%] lg:w-[120%] px-[15%] lg:px-[10%]">
