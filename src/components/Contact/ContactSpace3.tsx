  ...
  return(
    <div className="ml-1 mt-12">
      ...
      <div className="grid lg:grid-cols-[1fr_auto] mt-2">
        <div>
          <div className="tracking-wider text-[30px] md:text-[40px] lg:text-[32px] xl:text-[40px] 2xl:text-[40px] font-[800] leading-none">Оставьте заявку</div>
          <div className="text-xs text-[#999999] w-[90%] mt-3 font-[Inter] font-medium">Мы проанализируем, где ваш  бизнес теряет деньги, и предложим решение.</div>
        </div>
      </div>
    </div>
