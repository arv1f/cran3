function ContactContainer3() {
  return(
    <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 mt-8 px-3 lg:px-0">
      <div className="border border-[#262626] grid grid-rows-[10%_42%_3%_45%] sm:grid-rows-[13%_42%_5%_30%] p-6 h-[900px] lg:h-[505px]">
        ...
        <div className="row-start-4 grid grid-rows-3 lg:grid-cols-[30%_0.5%_34%_0.5%_32%] gap-1 h-[500px]">
          <div className="-ml-2 lg:ml-0 grid grid-rows-[50%_30%_auto] lg:grid-rows-[25%_40%_auto] gap-1 flex justify-center lg:items-center px-2">
            <div className="text-sm text-[#999999] text-left lg:text-nowrap">Кол-во проектов в<br className="hidden lg:block" />месяц</div>
          ...
          <div className="grid grid-rows-[50%_30%_auto] lg:grid-rows-[25%_40%_auto] gap-1 flex justify-center items-center px-2">
            <div className="text-sm text-[#999999] text-left lg:text-nowrap">Кол-во сотрудников<br className="hidden lg:block"  />на проект</div>
            <div className="text-lg font-[700] text-white min-w-[140px] text-left text-nowrap">5</div>
          </div>
          <div className="hidden lg:block border-l border-[#262626]"></div>
          <div className="grid grid-rows-[50%_30%_auto] lg:grid-rows-[20px_auto] gap-1 flex justify-center items-center px-3">
            <div className="text-sm text-[#999999] text-center">Стоимость</div>
            <div className="text-lg font-[700] text-white min-w-[140px] text-left lg:text-nowrap">от 750 000 ₽ /<br className="hidden lg:block" />месяц</div>
          </div>
        </div>
      </div>
      ...
      <div className="border border-[#262626] grid grid-rows-[10%_52%_3%_35%] sm:grid-rows-[13%_42%_5%_40%] p-6 h-[820px] sm:h-[505px]">
        ...
        <div className="row-start-4 grid grid-rows-3 lg:grid-cols-[30%_0.5%_34%_0.5%_32%] gap-1 h-[500px]">
          ...
          <div className="hidden lg:block border-l border-[#262626]"></div>
          <div className="grid grid-rows-[30%_45%_auto] lg:grid-rows-[20px_auto] gap-1 flex justify-center items-center px-3">
            <div className="text-sm text-[#999999] text-center">Стоимость</div>
            <div className="text-lg font-[700] text-white min-w-[140px] text-left lg:text-nowrap">от 1 750 000 ₽ /<br className="hidden lg:block" />месяц</div>
          </div>
        </div>
      </div>
    </div>
