function ContactContainer2() {
  return(
    <div className="relative grid grid-rows-6 md:grid-rows-3 lg:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-8 mt-10 font-medium px-3 lg:px-0">
      <div className="col-start-1 row-start-1 inset-0 p-[2px] bg-gradient-to-br from-[#5D3C7A] to-transparent z-0 ">
        <div className="px-3 grid grid-rows-[32%_auto] w-full h-full bg-[#0f0f0f] bg-[linear-gradient(120.79deg,#9966CC_-49.01%,rgba(153,102,204,0)_13.65%)] py-8 px-2 lg:px-8">
      ...
      <div className="col-start-1 row-start-2 md:col-start-2 md:row-start-1 lg:col-start-2 lg:row-start-1 inset-0 p-[2px] bg-gradient-to-br from-[#5D3C7A] to-transparent z-0 ">
        <div className="px-3 grid grid-rows-[32%_auto] w-full h-full bg-[#0f0f0f] bg-[linear-gradient(120.79deg,#9966CC_-49.01%,rgba(153,102,204,0)_13.65%)] py-8 px-2 lg:px-8">
      ...
      <div className="col-start-1 row-start-3 md:col-start-1 md:row-start-2 lg:col-start-3 lg:row-start-1 inset-0 p-[2px] bg-gradient-to-br from-[#5D3C7A] to-transparent z-0 ">
        <div className="px-3 grid grid-rows-[32%_auto] w-full h-full bg-[#0f0f0f] bg-[linear-gradient(120.79deg,#9966CC_-49.01%,rgba(153,102,204,0)_13.65%)] py-8 px-2 lg:px-8">
      ...
      <div className="col-start-1 row-start-4 md:col-start-2 md:row-start-2 lg:col-start-1 lg:row-start-2 inset-0 p-[2px] bg-gradient-to-br from-[#5D3C7A] to-transparent z-0 ">
        <div className="px-3 grid grid-rows-[32%_auto] w-full h-full bg-[#0f0f0f] bg-[linear-gradient(120.79deg,#9966CC_-49.01%,rgba(153,102,204,0)_13.65%)] py-8 px-2 lg:px-8">
      ...
      <div className="col-start-1 row-start-5 md:col-start-1 md:row-start-3 lg:col-start-2 lg:row-start-2 inset-0 p-[2px] bg-gradient-to-br from-[#5D3C7A] to-transparent z-0 ">
        <div className="px-3 grid grid-rows-[32%_auto] w-full h-full bg-[#0f0f0f] bg-[linear-gradient(120.79deg,#9966CC_-49.01%,rgba(153,102,204,0)_13.65%)] py-8 px-2 lg:px-8">
      ...
      <div className="col-start-1 row-start-6 md:col-start-2 md:row-start-3 lg:col-start-3 lg:row-start-2 inset-0 p-[2px] bg-gradient-to-br from-[#5D3C7A] to-transparent z-0 ">
        <div className="px-3 grid grid-rows-[25%_auto] w-full h-full bg-[#0f0f0f] bg-[linear-gradient(120.79deg,#9966CC_-49.01%,rgba(153,102,204,0)_57.54%)] py-8 px-2 lg:px-8">
