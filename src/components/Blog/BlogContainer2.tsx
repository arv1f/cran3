...
function BlogContainer2 () {
  return(
    <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-4 items-center font-[Inter] font-medium">
      <div className="space-y-4">
        <div className="tracking-wider text-[30px] sm:text-[32px] md:text-[34px] lg:text-[36px] xl:text-[40px] 2xl:text-[42px] font-[800]">Оставайтесь с нами</div>
      ...
      <div className="flex items-center space-x-2 border border-[#262626] bg-[#101010] text-sm text-[#999999] px-2 py-3 mt-4 md:mt-0 mg:ml-[10%] md:w-[90%] lg:ml-[20%] lg:w-[80%] hover:border-[#404040] transition-colors">
