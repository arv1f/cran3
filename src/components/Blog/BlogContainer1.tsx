    ...
    <div className="grid mt-[125px] w-[120%] -ml-[10%] h-[600px] md:h-[580px]">
      <div className="w-full h-[420px] bg-[linear-gradient(64.9deg,#262626_0%,rgba(38,38,38,0)_53.056%)] px-3 md:px-[10%] grid grid-rows-[25%_40%] sm:grid-rows-[10%_35%] md:grid-rows-[30%_61%] grid-cols-12 border border-[#262626]">
        ...
        <div className="row-start-3 col-start-2 col-end-12 grid grid-rows-2">
          <div className="max-h-[80px] w-[100%] relative flex items-center space-x-2 border-[2px] rounded-[10px] border-[#262626] shadow-[0_0_0_10px_#191919] bg-[#101010] text-[#666666] px-2 py-3">
          ...
          <div className="grid grid-rows-2 gap-4 sm:gap-0 h-[200px] sm:h-[70px] -mt-[45px] sm:mt-2 sm:grid-rows-1 sm:grid-cols-2 mt-1 sm:border border-[#262626] sm:shadow-[0_0_0_10px_#191919] bg-[#101010]  ">
            ...
            <div className="max-h-[70px] row-start-1 md:-ml-[22%] sm:w-[97%] md:w-[120%] relative flex items-center space-x-2 border rounded border-[#262626] shadow-[0_0_0_10px_#191919] bg-[#101010] text-[#666666] px-2 py-2">
            ...
            <div className="max-h-[70px] row-start-2 sm:row-start-1 md:w-[120%] relative flex items-center space-x-2 border rounded border-[#262626] shadow-[0_0_0_10px_#191919] bg-[#101010] text-[#666666] px-2 py-2">
