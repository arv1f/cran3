  ...
  return(
    <div className="ml-3">
      ...
      <div className="grid lg:grid-cols-[1fr_auto] mt-2">
        <div>
          <div className="text-2xl md:text-[30px] lg:text-[30px] xl:text-[40px] 2xl:text-[40px] tracking-normal leading-tight font-bold">Что нас отличает от типовых IT-интеграторов</div>
