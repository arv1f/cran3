  ...
  return(
    <div className="ml-1">
      ...
      <div className="grid lg:grid-cols-[auto_115px] mt-2">
        <div>
          <div className="tracking-wider text-[30px] md:text-[40px] lg:text-[32px] xl:text-[40px] 2xl:text-[40px] font-[800] leading-none w-[96%] sm:w-[107%] xl:w-full">Дайджест наших статей</div>
