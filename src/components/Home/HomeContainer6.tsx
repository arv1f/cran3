...
function HomeContainer6() {
  ...
  <div className="mt-10 px-2 lg:px-0">
    <div className="gap-6 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
      <div className="border border-[#262626] p-6 gap-6 p-4 grid rounded-none">
        ...
        <div className="grid grid-cols-3 gap-2 text-xs w-[180px]">
      ...
      <div className="border border-[#262626] p-6 gap-6 p-4 grid">
