...
function HomeContainer4() {
  return(
    <div className='mt-12 grid grid-cols-1 lg:grid-cols-2 gap-8 w-full md:px-3'>
      <div className="grid gap-3 grid-rows-[180px_120px_auto] md:grid-rows-[140px_80px_auto] lg:grid-rows-[200px_80px_auto] xl:grid-rows-[120px_60px_auto]
      border border-[#262626] shadow-[0_0_0_6px_#191919] p-4 px-2 sm:px-4 md:px-8 pb-8 ml-[1%] sm:ml-0 w-[98%] lg:w-full">
        <div className="grid grid-rows-[auto_100px] xl:grid-cols-[auto_180px]">
          <div>
            ...
            <div className="text-[21px] sm:text-lg md:text-xl tracking-normal leading-tight font-bold mt-1">Внешний цифровой партнёр</div>
          </div>
        ...
        <div className="grid grid-rows-[10%_auto] border border-[#202020] gap-4 p-4 md:p-6 mt-6">
          <div className="text-sm font-[Inter] font-semibold">Для вас</div>
      ...
      border border-[#262626] shadow-[0_0_0_6px_#191919] p-4 px-2 sm:px-4 md:px-8 pb-8 ml-[1%] sm:ml-0 w-[98%] lg:w-full">
        <div className="grid grid-rows-[auto_100px] xl:grid-cols-[auto_180px]">
          <div>
            ...
            <div className="text-[21px] sm:text-lg md:text-xl tracking-normal leading-tight font-bold mt-1">Проектная коммерческая разработка</div>
          </div>
          <Button buttonType="purple" className="w-[180px] text-nowrap mt-4 xl:mt-7">Узнать подробнее</Button>
        </div>
        <div className="grid grid-cols-[53%_5%_47%]">
