...
function HomeContainer4() {
  return(
    <div className='mt-12 grid grid-cols-1 lg:grid-cols-2 gap-8 w-full px-3'>
      <div className="grid grid-rows-[30%_20%_50%] sm:grid-rows-[30%_20%_45%] md:grid-rows-[35%_15%_50%] border border-[#262626] shadow-[0_0_0_6px_#191919] p-4 md:px-8 pb-7 md:pr-6 ml-[3%] lg:ml-0 w-[94.5%] lg:w-full h-[750px] md:h-[500px] lg:h-[650px]">
