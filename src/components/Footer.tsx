...
function Footer() {
  return(
    <div className="grid grid-cols-[36%_12.8%_12.8%_12.8%_12.8%_12.8%] text-xs gap-2 mt-24">
      <div>
        <div className="-ml-6 grid grid-cols-[38px_auto] md:grid-cols-[40px_auto] lg:grid-cols-[44px_auto] col-start-1 h-[48px] lg:h-[55px] mt-[2px]"> 
      ...
      <div className="grid grid-rows-8 h-[360px]">
      ...
      <div className="grid grid-rows-9 h-[405px]">
      ...
      <div className="grid grid-rows-5 h-[225px]">
      ...
      <div className="grid grid-rows-6 h-[270px]">
      ...
      <div className="grid grid-rows-3 h-[135px]">
