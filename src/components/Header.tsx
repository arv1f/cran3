...
function Header({ isUpHeaderVisible }: HeaderProps) {
  ...
  return(
      <div className={`fixed -left-1 z-50 grid md:grid-cols-[144px_60%_10%] lg:grid-cols-[25%_63%_12%] gap-3 py-[6px] md:py-[10px] text-nowrap bg-[#141414] px-[10%] w-[101%] border border-[#262626] transition-all duration-1000 ${isUpHeaderVisible ? 'top-[64px] md:top-[38px] lg:top-[52px]' : 'top-0'}`}>
        <div className="ml-[10%] sm:ml-0 grid grid-cols-[38px_auto] md:grid-cols-[40px_auto] lg:grid-cols-[44px_auto] col-start-1 mt-[2px]"> 
          <div className="w-[144px] md:w-[140px] lg:w-[184px] h-[49px]">
            <CRANicon width={'100%'} height={"100%"} />
          </div>
        </div>

        <div className="hidden sm:grid sm:grid-cols-[90px_120px_80px_60px] lg:grid-cols-[110px_140px_100px_80px] xl:grid-cols-[20%_25%_20%_20%] col-start-2 mt-[5px]">
