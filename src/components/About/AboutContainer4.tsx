...
function AboutContainer4() {
  return (
    <div className="grid place-items-center lg:place-items-[] grid-cols-1 gap-4 sm:grid-cols-2 md:px-[10%] lg:px-0 lg:grid-cols-4 mt-10">
      ...
      <div className="border border-[#262626] p-4 flex flex-col h-[450px] xl:h-[450px]">
        ...
        <div className="text-center mb-4">
          ...
          <div className="text-xs text-[#999999] font-[Inter] mt-1">CEO</div>
        </div>
      </div>
      ...
      <div className="border border-[#262626] p-4 flex flex-col h-[450px] xl:h-[450px]">
        ...
        <div className="text-center mb-4">
          ...
          <div className="text-xs text-[#999999] font-[Inter] mt-1">CTO</div>
        </div>
      </div>
      ...
      <div className="border border-[#262626] p-4 flex flex-col h-[450px] xl:h-[450px]">
        ...
        <div className="text-center mb-4">
          ...
          <div className="text-xs text-[#999999] font-[Inter] mt-1">CPO</div>
        </div>
      </div>
      ...
      <div className="border border-[#262626] p-4 flex flex-col h-[450px] xl:h-[450px]">
        ...
        <div className="text-center mb-4">
          ...
          <div className="text-xs text-[#999999] font-[Inter] mt-1">TeamLead</div>
        </div>
      </div>
    </div>
  );
