...
function AboutContainer5() {
  return(
    <div className="border border-[#262626] relative px-[11%] md:px-[10%] py-10 w-[120%] h-[360px] md:h-[260px] -ml-[10%] mt-16">
      <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] items-center justify-center gap-6 h-full md:ml-1 lg:ml-0 md:mr-1 lg:mr-0">
        <div className="z-10">
          <div className="text-2xl md:text-[30px] lg:text-[30px] xl:text-[40px] 2xl:text-[40px] tracking-normal leading-10 font-[600] w-[90%] md:w-full">Хочешь работать и расти с нами?</div>
          <div className="text-xs text-[#999999] mt-4">Нам нужны разработчики и аналитики, которые хотят решать задачи — а не просто писать код</div>
        </div>
