...
function AboutContainer1() {
  return(
    <div className="relative grid grid-cols-1 lg:grid-cols-[55.5%_44.5%] h-[550px] lg:h-[500px] mt-6 lg:mt-10">
      <div className="col-start-1 pt-1 w-[190%] z-10 px-4 lg:px-0">
        <div className="text-xl md:text-[20px] lg:text-[24px] xl:text-[36px] 2xl:text-[40px] tracking-normal leading-tight font-[800]">О компании</div>
