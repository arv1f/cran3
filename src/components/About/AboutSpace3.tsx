function AboutSpace3() {
  return(
    <div className="ml-4 lg:ml-2 mt-8 lg:mt-16">
      ...
      <div className="grid lg:grid-cols-[1fr_auto] mt-2">
        <div>
          <div className="text-2xl md:text-[30px] lg:text-[30px] xl:text-[40px] 2xl:text-[40px] tracking-normal leading-tight font-bold">Основная команда</div>
